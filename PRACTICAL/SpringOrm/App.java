...
import com.spring.SpringOrm.dao.EmployeeService;
import com.spring.SpringOrm.dao.EmployeeServiceImp;
...
public class App {
	...
	public static void main(String[] args) {
		...
		EmployeeService bean = apc.getBean("employeeService", EmployeeServiceImp.class);
		...
		while (true) {
			...
			case 7:
				System.out.println("Generate Bulk Employee");
				bean.generateBulkEmployee();
				break;
